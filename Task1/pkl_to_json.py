...
class ReadPkl:
    def __init__(self):
        ######################################|| 개인 설정 ||####################################################################
        pkl_location = 'C:\Users\내 PC\Desktop\2025 Network Ai hackathon\2025_Network_AI_hackathon\Task1\test_outputs_sample.pkl'     #.pkl 저장 위치 ※.pkl확장자까지 명시할 것!!!
        json_save_or_not = True                                                                                     # json 저장 여부, 만약 False일 경우 콘솔에만 출력
        json_location = 'C:\Users\내 PC\Desktop\2025 Network Ai hackathon\2025_Network_AI_hackathon\Task1\input.json'  # json 저장 위치 ※json 이름은 임의로 설정
        #########################################################################################################################
